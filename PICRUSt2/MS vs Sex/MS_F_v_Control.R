...
metadata <- metadata %>% 
  filter(disease == c('MS_F', 'Control_F'))
...
abundance_desc = abundance_desc[,-c(40:ncol(abundance_desc))] 
...
ggsave("heatmap_F.png", plot = heatmap2, width = 10, height = 6)
...
ggsave("sigres_F.png", plot = sig_res2, width = 10, height = 6)
