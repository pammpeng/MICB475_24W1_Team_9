# Purpose: The goal of this script is to perform picrust2 functional analysis between the MS v/s control groups
...
# generating data table for the bar plots
sig_res <- sig_res[order(sig_res$log2FoldChange),]

# generating bar plots for differential expression
